...
const AnimatedCTAButton = ({ 
  ...
  return (
    ...
    >
      ...
      <motion.button
        onClick={onClick}
        className={`relative ${sizeClasses[size]} bg-gradient-to-br from-[#1a1a3a] to-[#2d2d5a] text-yellow-400 font-semibold rounded-xl cursor-pointer inline-flex items-center gap-3 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-yellow-400/30`}
        whileHover={{ 
